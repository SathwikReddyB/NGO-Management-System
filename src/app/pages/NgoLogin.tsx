...
import { ArrowLeft, Heart, Building2, Loader2 } from "lucide-react";
...
export function NgoLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await api.loginNgo(formData);
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-gray-600">
                ...
                <Link to="/ngo/register" className="text-black hover:underline cursor-pointer">
                  Register your NGO
                </Link>
              </p>
            </div>
